...
test_route "GET" "/prefacturas/webhook" "" "true"
test_route "POST" "/prefacturas/webhook" '{"evento":"factura","id":"FAC123"}' "true"
echo ""
...
echo ""
echo "  17. GET /prefacturas/webhook → WebhookSettings.tsx"
echo "      └─ UI Path: Finanzas → Settings → Webhooks"
echo ""
echo "  18. POST /prefacturas/webhook → WebhookHandler.tsx"
