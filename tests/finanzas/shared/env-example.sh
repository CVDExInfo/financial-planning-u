...
# with the actual endpoints, Cognito tester credentials, and project IDs.
...
# Seed project identifiers used across scripts
export FINZ_PROJECT_ALMOJABANAS="PRJ-HEALTHCARE-MODERNIZATION"
export FINZ_PROJECT_IA="PRJ-FINTECH-PLATFORM"
export FINZ_PROJECT_RETAIL="PRJ-RETAIL-ANALYTICS"
export FINZ_PROJECT_RECONCILIATION="${FINZ_PROJECT_ALMOJABANAS}"
export FINZ_SAMPLE_LINE_ITEM="RB-SAMPLE-001"
