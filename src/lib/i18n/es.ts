...
export const ES_TEXTS = {
  ...
  baseline: {
    ...
    valoresOriginales: "Valores Originales del Baseline",
    recursosHumanos: "Recursos Humanos (MOD)",
    gastosServicios: "Gastos y Servicios",
    role: "Rol",
    level: "Nivel",
    fte: "FTE",
    tarifaHora: "Tarifa/hora",
    hrsMes: "Hrs/mes",
    ...
    oneTimeAmount: "Monto Único",
    subtotal: "Subtotal",
    materializarAhora: "Materializar Ahora",
    materializarConfirm: "¿Desea materializar este baseline ahora? Esto generará los rubros en el sistema.",
    materializarSuccess: "Baseline materializado exitosamente",
    materializarError: "Error al materializar el baseline",
  },
