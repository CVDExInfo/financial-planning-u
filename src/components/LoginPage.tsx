...
export function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white/80 via-slate-50/70 to-slate-100/70 dark:from-slate-950 dark:via-slate-950/90 dark:to-slate-900/80" />
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="flex items-center gap-3 text-sm font-medium text-emerald-800 dark:text-emerald-200">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 ring-1 ring-emerald-200 dark:bg-emerald-500/10 dark:ring-emerald-400/30">
            <Logo className="h-8" />
          </div>
            ...
            <div className="flex flex-col justify-between gap-8 lg:col-span-3">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-base text-slate-700 dark:text-slate-200/90">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl border border-slate-200/80 bg-white/90 p-4 text-slate-900 shadow-md shadow-emerald-100 dark:border-white/10 dark:bg-slate-900/80 dark:text-white dark:shadow-black/20">
