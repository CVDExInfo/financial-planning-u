  ...
  const mockChanges: ChangeRequest[] = [
    {
      ...
      description: 'Add one additional senior developer for Q2 to meet accelerated delivery timeline',
      businessJustification: 'Client has requested delivery 2 months ahead of schedule. Current team capacity analysis shows we need one additional senior developer to meet the new deadline without compromising quality.',
      impact: 25500,
      status: 'pending',
      ...
      approvalSteps: [
        {
          ...
          status: 'approved',
          comments: 'Approved based on client requirements and timeline analysis. Budget impact is justified by accelerated delivery premium.',
    ...
    },
    {
      ...
      description: 'Upgrade to higher-tier instances for performance optimization',
      businessJustification: 'Current infrastructure is hitting CPU and memory limits during peak usage. Upgrade will prevent performance degradation and ensure SLA compliance.',
      impact: 8000,
      status: 'approved',
      ...
      approvalSteps: [
        {
          ...
          status: 'approved',
          comments: 'Performance metrics support the need for upgrade. Cost is within acceptable range.',
        ...
        },
        {
          ...
          status: 'approved',
          comments: 'Approved. Infrastructure costs are within operational budget variance.',
    ...
    },
    {
      ...
      description: 'Early renewal of analytics platform license to secure better pricing',
      businessJustification: 'Vendor offered 15% discount for early renewal. Current license expires in 6 months, early renewal saves $3,000 annually.',
      impact: -3000,
      status: 'approved',
      ...
      approvalSteps: [
        {
          ...
          status: 'approved',
          comments: 'Excellent opportunity for cost savings. Vendor pricing verified and within market rates.',
  ...
  const handleApprovalAction = (requestId: string, action: 'approve' | 'reject', comments: string) => {
    ...
    setSelectedChange(prevChange => {
      ...
      return {
        ...
        currentStep: action === 'approve' ? prevChange.currentStep + 1 : prevChange.currentStep,
