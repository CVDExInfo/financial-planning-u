...
export function LaborStep({ data, setData, onNext }: LaborStepProps) {
  ...
  const updateLaborItem = (index: number, field: keyof LaborEstimate, value: any) => {
    ...
    if (field === 'country' || field === 'level') {
      ...
      const preset = LABOR_PRESETS[country as keyof typeof LABOR_PRESETS]?.[level as keyof typeof LABOR_PRESETS['Colombia']];
      if (preset) {
  ...
  const getTotalCost = () => {
    return laborEstimates.reduce((sum, item) => sum + calculateItemTotal(item), 0);
  };
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Define your team composition, rates, and duration for accurate labor cost projections
        </p>
      </div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Add roles with their associated costs and duration</p>
        </div>
                  ...
                  {laborEstimates.map((item, index) => (
                    <TableRow key={index}>
                      <TableCell>
                        <Select
                          value={item.role}
                          onValueChange={(value) => updateLaborItem(index, 'role', value)}
                        >
                      ...
                      <TableCell>
                        <Select
                          value={item.country}
                          onValueChange={(value) => updateLaborItem(index, 'country', value)}
                        >
                      ...
                      <TableCell>
                        <Select
                          value={item.level}
                          onValueChange={(value) => updateLaborItem(index, 'level', value as any)}
                        >
                      ...
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'fte_count', parseFloat(e.target.value) || 0)}
                          className="w-16"
                          min="0.1"
                          step="0.1"
                        />
                      ...
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'hourly_rate', parseFloat(e.target.value) || 0)}
                          className="w-24"
                        />
                      </TableCell>
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'hours_per_month', parseFloat(e.target.value) || 0)}
                          className="w-20"
                        />
                      </TableCell>
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'on_cost_percentage', parseFloat(e.target.value) || 0)}
                          className="w-20"
                        />
                      </TableCell>
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'start_month', parseInt(e.target.value) || 1)}
                          className="w-16"
                          min="1"
                        />
                      </TableCell>
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) => updateLaborItem(index, 'end_month', parseInt(e.target.value) || 1)}
                          className="w-16"
                          min="1"
                        />
                      </TableCell>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Start by adding team members to estimate labor costs for your project
            </p>
            <Button onClick={addLaborItem} className="gap-2">
              <Plus size={16} />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {laborEstimates.reduce((sum, item) => sum + item.fte_count, 0)} FTE
                </p>
              </div>
              <div>
                <Label className="text-muted-foreground">Avg. Monthly Rate</Label>
                <p className="text-2xl font-bold">
                  ${(laborEstimates.reduce((sum, item) => sum + item.hourly_rate, 0) / laborEstimates.length).toLocaleString()}
                </p>
              </div>
              <div>
      ...
      <div className="flex justify-end">
        <Button onClick={handleNext} disabled={laborEstimates.length === 0} className="gap-2">
